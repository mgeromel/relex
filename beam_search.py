...
def beam_search(self, input_ids = None, num_beams = 1, max_length = 64, **model_kwargs,):
	...
	attention_mask = encoder_input_ids.ne(0).long()
	...
	for length in range(max_length - 1):
		...
		r_logits.view(batch_size, num_beams, self.relat_size)
		...
		decoder_input_ids = torch.cat([decoder_input_ids, next_decoder_input_ids], dim = 2)
	...
	best_beams, best_index = torch.topk(beam_scores, 1, dim = -1)
