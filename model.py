...
class TestModel(torch.nn.Module):
	...
	def __init__(self, gramm = None, vocab = None, point_size = 256, config = None):
		...
		# Loading Model
		self.b_model = AutoModelForSeq2SeqLM.from_pretrained("facebook/bart-base")
		...
		self.point_head = torch.nn.Linear( self.d_model + self.point_size, 2 * self.point_size)
